...
CREATE TABLE `post` (
  ...
  PRIMARY KEY (`post_id`)
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='回复表';
...
INSERT INTO `post` VALUES (1,1511857009,0,NULL,1),(2,1511858000,0,NULL,1),(3,1511858009,0,NULL,1),(4,1511858023,0,NULL,1),(5,1511858029,0,NULL,1),(6,1511859197,0,NULL,1),(7,1511873173,0,NULL,9);
...
INSERT INTO `post_text` VALUES (1,'的撒大'),(2,'V大市场'),(3,'&lt;p&gt;测试&lt;/p&gt;'),(4,'&lt;p&gt;继续测试&lt;/p&gt;'),(5,'&lt;p&gt;可劲测试&lt;/p&gt;'),(6,'&lt;p&gt;&amp;lt;sc&lt;x&gt;ript&amp;gt;alert(&amp;quot;11&amp;quot;);&amp;lt;/sc&lt;x&gt;ript&amp;gt;&lt;/p&gt;'),(7,'&lt;p&gt;厕所&lt;/p&gt;');
...
INSERT INTO `user` VALUES (7,'cutephp',NULL,NULL,'https://avatars2.githubusercontent.com/u/3415206?v=4',3415206);
